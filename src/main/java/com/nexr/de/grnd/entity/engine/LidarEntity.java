...
@Component
public class LidarEntity implements EngineEntity {
	
	@Value("${engine.lidar.nameByMetadata}")
	private String nameByMetadata;
	
	@Value("${engine.lidar.imageName}")
	private String imageName;
	
	@Value("${engine.lidar.namespace}")
	private String namespace;
	
	
	@Override
	public String getEngineName() {
		return CodeConstants.ENGINE_NAME_LIDAR;
	}
