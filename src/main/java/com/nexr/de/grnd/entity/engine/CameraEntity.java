...
@Component
public class CameraEntity implements EngineEntity {
	
	@Value("${engine.camera.nameByMetadata}")
	private String nameByMetadata;
	
	@Value("${engine.camera.imageName}")
	private String imageName;
	
	@Value("${engine.camera.namespace}")
	private String namespace;
	
	
	@Override
	public String getEngineName() {
		return CodeConstants.ENGINE_NAME_CAMERA;
	}
